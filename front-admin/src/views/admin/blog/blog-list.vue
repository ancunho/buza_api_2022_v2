...
export default {
    ...
    methods: {
        ...
        tableList() {
            ...
            var params = {};
            params.postType = '03';
            _this.$request.post("/system/post/list?page=" + _this.currentPage + "&limit=" + _this.pageSize, params).then((response) => {
        ...
        saveItem(item) {
            ...
            _this.loading = true;
            _this.$request.post("/system/post/proc", item).then(response => {
