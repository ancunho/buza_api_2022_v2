...
<!--          </div>-->
        ...
        <ul class="nav nav-list">
          ...
          <li class="active open">
            ...
            <ul class="submenu">
              <li class="" id="system-user-sidebar">
                <router-link to="/system/user"><i class="menu-icon fa fa-caret-right"></i>用户管理</router-link>
                <b class="arrow"></b>
              </li>
              <li class="" id="system-role-sidebar">
                <router-link to="/system/role"><i class="menu-icon fa fa-caret-right"></i>权限管理</router-link>
                <b class="arrow"></b>
              </li>
          ...
          <li class="active">
            ...
            <ul class="submenu">
              <li class="" id="shop-list-sidebar">
                <router-link to="/shop/list"><i class="menu-icon fa fa-caret-right"></i>门店列表</router-link>
                <b class="arrow"></b>
              </li>
            </ul>
          </li>
