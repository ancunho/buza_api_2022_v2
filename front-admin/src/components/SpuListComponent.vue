<template>
    <div v-loading="loading">
        ...
        <el-table :data="itemList" style="width: 100%; margin-top: 1.5rem;">
            ...
            <el-table-column prop="classificationId" label="CATEGORY_ID" width="150" ></el-table-column>
...
<!--            <el-table-column prop="spuType" label="SPU_TYPE" width="130"></el-table-column>-->
            ...
            <el-table-column label="操作" align="center">
                <template slot-scope="scope">
                    <el-button @click="handleEmitSpuItem(scope.row)" type="primary" icon="el-icon-edit-outline">选择</el-button>
...
export default {
    ...
    methods: {
        ...
        handleEmitSpuItem(item) {
            let _this = this;
            _this.$emit("childEmitSpuItem", item);
